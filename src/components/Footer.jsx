...
function Footer() {
  ...
  return (
    <>
      <div className="bg-[url('/footer-1.png')] bg-no-repeat bg-cover bg-center py-4"></div>
      <footer className="bg-[url('/footer-bg.png')] bg-no-repeat bg-cover bg-center md:bg-left xl:bg-bottom py-16 px-4 md:px-10">
        <div className="container">
          <div className="relative flex flex-col gap-10">
            <div className="flex flex-col md:flex-row md:items-center gap-8 lg:gap-20 md:max-w-[80%] lg:max-w-[60%] md:mx-auto">
              {/* Navigation Links */}
              <motion.nav
              ...
              >
                <Image
                  ...
                  width={100}
                  height={100}
                  className="w-auto h-[60vh] object-contain relative -left-1.5"
                />
              </motion.div>
