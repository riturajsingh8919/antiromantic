...
const SingleProductPage = ({ productSlug }) => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[url('/store/store-sec-bg.png')] pt-[64px] md:pt-0">
        {/* Main Product Section */}

        <div className="grid grid-cols-1 md:grid-cols-[45%_55%] gap-5 md:gap-0">
          ...
          {/* Right Column - Static Product Details (55%) */}
          <div className="relative">
            <div
              ref={rightColumnRef}
              className="md:sticky md:top-26 space-y-12 pb-16"
            >
              {/* Product Info */}
              <div className="space-y-8 px-4 md:px-0 py-16 md:py-0 md:max-w-[75%] mx-auto">
                {/* Title and Favorite */}
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-3">
                    <p className="text-2xl font-medium text-[#736C5F]">
                ...
                <div className="space-y-4 mt-4">
                  <div className="flex justify-between items-center">
                    <label className="text-base font-normal text-[#28251F] tracking-wide">
                      select size
                    </label>
                    <button
                      onClick={() => {
                    ...
                    {product.sizeStock && product.sizeStock.length > 0 ? (
                      product.sizeStock.map((sizeInfo) => (
                        <button
                          ...
                          className={`w-12 h-12 text-base font-normal transition-colors relative !uppercase ${
                            selectedSize === sizeInfo.size
                              ? "border-[#736C5F] border text-[#736C5F] !font-bold"
                              : sizeInfo.stock === 0
                              ? "border-[#736C5F] text-gray-400 cursor-not-allowed"
                              : "border-[#736C5F] text-[#736C5F] hover:border-[#736C5F] cursor-pointer"
                          }`}
                        >
                          {sizeInfo.size}
                          {sizeInfo.stock === 0 && (
                ...
                <button
                  ...
                  className="w-full bg-[#E4DFD3] text-[#736C5F] py-3 px-6 text-lg font-medium tracking-wider hover:bg-[#736C5F] hover:text-[#E4DFD3] transition-colors flex items-center justify-center gap-2 border-b-1 border-[#736C5F] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    ...
                    <nav className="grid grid-cols-2 md:grid-cols-4 gap-8">
                      {tabs.map((tab) => (
                        <button
                          ...
                          className={`py-3 text-base font-normal transition-colors cursor-pointer ${
                            activeTab === tab.key
                              ? "text-[#736C5F] border-b-2 border-[#28251F] !font-medium"
      ...
      <div className="grid grid-cols-1 md:grid-cols-[45%_55%] gap-0 bg-[url('/store/store-sec-bg.png')]">
        {loading ? (
